...
const LinkChip = ({ children, href, icon: Icon, color, className = "" }: { 
  ...
  >
    ...
    <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 truncate mt-0.5">{href}</p>
    </div>
...
export default function ContactPage() { 
  ...
  /**
   * Mocking an Avatar component using Tailwind/Lucide for the placeholder.
   */
  const MockAvatar = () => (
    <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-500 dark:text-gray-400 border-4 border-white dark:border-gray-800 shadow-xl overflow-hidden">
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8 font-sans"> 
      <div className="mx-auto max-w-3xl space-y-6"> 
        ...
        <Card className="p-0 overflow-hidden relative">
            ...
            <div className="h-20 sm:h-32 bg-gradient-to-r from-blue-600/90 to-blue-400/90 dark:from-blue-800 dark:to-blue-600 shadow-inner"></div>
        ...
        {profile?.bio && (
            <Card>
                <h2 className="text-xl font-bold mb-4 flex items-center text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2">
